...
| :---: | :---: |
| <img src="test_images/test-color.jpg" width="400"> | <img src="test_images/test_color_output.png" width="400"> |

| Original Image | Scanned Output |
| :---: | :---: |
| <img src="test_images/test-pencil.jpg" width="400"> | <img src="test_images/test_pencil_output.png" width="400"> |
...
```
python3 scan.py test_images/test-color.jpg --colors r,b,g,bl --output test_color_output
```
